...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function zo(e) {
		...
		if (t ??= {
			data: [],
			index: 0
		}, n === null && (n = Io(), P.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = T;
		return t.index++, n;
	}
	function Bo(e, t) {
	...
	n(), t.exports = s();
})), l = n(), u = o(), d = c(), f = "jobhunter:page-rendered";
function p(e, t) {
	let n = (e) => {
		let n = e.detail?.page;
		n && t(n);
	};
	return e.addEventListener(f, n), () => e.removeEventListener(f, n);
}
//#endregion
...
var m = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), h = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), g = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), _ = (e) => {
	...
	return !1;
}, b = (0, l.createContext)({}), x = () => (0, l.useContext)(b), ee = (0, l.forwardRef)(({ color: e, size: t, strokeWidth: n, absoluteStrokeWidth: r, className: i = "", children: a, iconNode: o, ...s }, c) => {
	...
	return (0, l.createElement)("svg", {
		...
		...!a && !y(s) && { "aria-hidden": "true" },
		...s
	}, [...o.map(([e, t]) => (0, l.createElement)(e, t)), ...Array.isArray(a) ? a : [a]]);
}), S = (e, t) => {
	let n = (0, l.forwardRef)(({ className: n, ...r }, i) => (0, l.createElement)(ee, {
		ref: i,
		iconNode: t,
		...
		children: [
			/* @__PURE__ */ (0, T.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, T.jsx)("img", {
					...
					"职途",
					/* @__PURE__ */ (0, T.jsx)("br", {}),
					/* @__PURE__ */ (0, T.jsx)("strong", { children: "AI" })
				] })]
			}),
			/* @__PURE__ */ (0, T.jsx)("nav", {
				className: "nav",
				"aria-label": "主导航",
				children: w.map(({ page: t, label: n, icon: r }) => /* @__PURE__ */ (0, T.jsxs)("button", {
					className: `nav-item${e === t ? " active" : ""}`,
					"data-page": t,
					type: "button",
					"aria-current": e === t ? "page" : void 0,
					children: [/* @__PURE__ */ (0, T.jsx)(r, { "aria-hidden": "true" }), /* @__PURE__ */ (0, T.jsx)("span", { children: n })]
				}, t))
			}),
			/* @__PURE__ */ (0, T.jsxs)("div", {
				className: "provider-mini",
				children: [/* @__PURE__ */ (0, T.jsx)("span", { id: "providerDot" }), /* @__PURE__ */ (0, T.jsxs)("div", { children: [/* @__PURE__ */ (0, T.jsx)("b", {
					id: "providerName",
					children: "本地兜底"
...
function se({ windowObject: e = window }) {
	let [t, n] = (0, l.useState)(() => oe(e));
	return (0, l.useEffect)(() => p(e, n), [e]), /* @__PURE__ */ (0, T.jsx)(ae, { activePage: t });
}
//#endregion
//#region frontend/src/app/main.tsx
var ce = document.getElementById("reactAppRoot");
if (!ce) throw Error("Missing React composition root: #reactAppRoot");
var le = (0, d.createRoot)(ce);
(0, u.flushSync)(() => {
	le.render(/* @__PURE__ */ (0, T.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, T.jsx)(se, {}) }));
});
//#endregion
